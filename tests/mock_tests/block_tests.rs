...
// use safe_llvm::{
//     interface::LLVMApi, 
//     memory_management::ir_pointer::SafeLLVMPointer
// };
// mockall::mock! {
//     BlockLLVMApi {}
//     impl LLVMApi for BlockLLVMApi {
//         fn create_basic_block(&self, context: LLVMContextRef, function: LLVMValueRef, name: &str) -> SafeLLVMPointer<LLVMBasicBlockRef>;
//         fn get_current_block(&self, builder: *mut llvm::LLVMBuilder) -> SafeLLVMPointer<LLVMBasicBlockRef>;
//         fn create_cond_br(&self, builder: LLVMBuilderRef, condition: LLVMValueRef, then_bb: LLVMBasicBlockRef, else_bb: LLVMBasicBlockRef) -> SafeLLVMPointer<LLVMValueRef>;
//         fn create_br(&self, builder: LLVMBuilderRef, target_bb: LLVMBasicBlockRef) -> SafeLLVMPointer<LLVMValueRef>;
//         fn insert_before_basic_block(&self, context: LLVMContextRef, before_target: LLVMBasicBlockRef, name: &str) -> SafeLLVMPointer<LLVMBasicBlockRef>;
...
//         fn get_first_instruction(&self, bb: LLVMBasicBlockRef) -> SafeLLVMPointer<LLVMValueRef>;
//         fn get_last_instruction(&self, bb: LLVMBasicBlockRef) -> SafeLLVMPointer<LLVMValueRef>;   
//         fn create_phi(&self, builder: LLVMBuilderRef, possible_values: &[(LLVMValueRef, LLVMBasicBlockRef)], name: &str) -> SafeLLVMPointer<LLVMValueRef>; 
//     }
// }
...
//     let raw_ptr: SafeLLVMPointer<LLVMBasicBlockRef> = SafeLLVMPointer::new(Some(std::ptr::null_mut()));
...
//     let bb: SafeLLVMPointer<LLVMBasicBlockRef> = (&mock_api).create_basic_block(context, function, "test");
...
//     let bb: SafeLLVMPointer<LLVMBasicBlockRef> = (&mock_api).get_current_block(builder);
...
//     let mut mock_api: MockBlockLLVMApi = MockBlockLLVMApi::new();
//     let raw_ptr: SafeLLVMPointer<LLVMValueRef> = SafeLLVMPointer::new(Some(std::ptr::null_mut()));
...
//     let bb: SafeLLVMPointer<LLVMValueRef> = (&mock_api).create_cond_br(builder, condition, then_bb, else_bb);
...
//     let raw_ptr = SafeLLVMPointer::new(Some(std::ptr::null_mut()));
