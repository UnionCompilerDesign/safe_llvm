use safe_llvm::{
    ...
    jit::{execution_engine::ExecutionEngine, target::*},
    memory_management::resource_pools::ResourcePools, utils::utils_struct::Utils,
};
...
fn test_execute_int_function() {
    ...
    pools.position_builder(builder_tag, bb_tag);
...
fn test_execute_float_function() {
    ...
    match Utils::write_to_file(module.clone(), "test_execute_float") {
        Ok(_) => {}
        Err(e) => {
