...
fn test_create_basic_block() {
    ...
    match common::io::write_ir_to_file(module.clone(), "test_basic_block") {
        Ok(_) => {}
        Err(e) => {
...
fn test_get_current_block() {
    ...
    match common::io::write_ir_to_file(module.clone(), "test_get_current_block") {
        Ok(_) => {}
        Err(e) => {
            eprintln!("File write error: {}", e);
            panic!();        
...
fn test_get_next_and_previous_block() {
    ...
    let function_tag = resource_pools.add_function_to_module(module_tag, DEFAULT_FUNCTION_NAME, function_value).expect("Failed to add function to module");
    let builder_tag = resource_pools.create_builder(context_tag).expect("Failed to create builder");
    let bb1_tag = resource_pools.create_basic_block(context_tag, function_tag, "block_1").expect("Failed to create block");
...
fn test_create_after_block() {
    ...
    resource_pools.position_builder_at_end(builder_tag, bb4_tag);
    assert_eq!(resource_pools.get_next_block(builder_tag).expect("Failed to get next block tag!"), bb3_tag);
    resource_pools.position_builder_at_end(builder_tag, bb3_tag);
...
fn test_create_cond_br() {
    ...
    match common::io::write_ir_to_file(module.clone(), "test_create_cond_br") {
        Ok(_) => {}
        Err(e) => {
            eprintln!("File write error: {}", e);
            panic!();        
...
fn test_create_br() {
    ...
    match common::io::write_ir_to_file(module.clone(), "test_create_br") {
        Ok(_) => {}
        Err(e) => {
            eprintln!("File write error: {}", e);
            panic!();        
...
fn test_insert_before_basic_block() {
    ...
    match common::io::write_ir_to_file(module.clone(), "test_insert_before_basic_block") {
        Ok(_) => {}
        Err(e) => {
            eprintln!("File write error: {}", e);
            panic!();        
...
fn test_delete_basic_block() {
    ...
    match common::io::write_ir_to_file(module.clone(), "test_delete_basic_block") {
        Ok(_) => {}
        Err(e) => {
            eprintln!("File write error: {}", e);
            panic!();        
...
fn test_get_first_instruction() {
    ...
    match common::io::write_ir_to_file(module.clone(), "test_get_first_instruction") {
        Ok(_) => {}
        Err(e) => {
            eprintln!("File write error: {}", e);
            panic!();        
...
fn test_get_last_instruction() {
    ...
    match common::io::write_ir_to_file(module.clone(), "test_get_last_instruction") {
        Ok(_) => {}
        Err(e) => {
            eprintln!("File write error: {}", e);
            panic!();        
